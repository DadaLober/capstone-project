...
const PriceTrendsComponent: React.FC<PriceTrendsComponentProps> = ({ properties }) => {
    ...
    const getPriceHistory = (property: Reservations) => {
        return property.propertyInfo[0]?.priceHistory?.map(history => ({
    ...
    const getAllPropertiesPriceHistory = () => {
        ...
        properties.forEach(property => {
            property.propertyInfo[0]?.priceHistory?.forEach(history => {
